...
export function ConversationItem({ conversation, isActive, onClick, onDelete }: ConversationItemProps) {
    return (
        <div
            className={`conversation-item group flex items-center justify-between px-3 py-2.5 rounded-lg cursor-pointer ${isActive ? 'active' : ''}`}
            onClick={onClick}>
            ...
            <div className="conversation-item-content flex-1 min-w-0">
                ...
                <div className="conversation-item-meta flex items-center gap-2 mt-1 text-xs">
