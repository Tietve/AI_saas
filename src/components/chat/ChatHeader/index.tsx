// src/components/chat/ChatHeader/index.tsx - REDESIGNED VERSION
...
export function ChatHeader({
    ...
    return (
        <>
            {/* Main Header - Reduced height from 64px to 56px */}
            <header className="chat-header h-14 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                <div className="h-full px-3 lg:px-4 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1 lg:gap-2 flex-shrink-0">
                        {/* System Prompt Toggle - Icon only on mobile */}
                        {onToggleSystemPrompt && (
                            <button
            ...
            {/* System Prompt Bar - Conditional render */}
            {showSystemPrompt && (
                <SystemPromptBar
                    show={true}
            ...
            {/* Mobile Model Selector - Show below header on small screens */}
